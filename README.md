...
**The current "latest" version is Unifi Controller 7.2.94.
...
|-----|-------------|-----------|
| [`latest` `v7.2.94`](https://github.com/jacobalberty/unifi-docker/blob/master/Dockerfile) | Current Stable: Version 7.2.94 as of 2022-09-21 |[Change Log 7.2.94](https://community.ui.com/releases/UniFi-Network-Application-7-2-94/2ab774d1-0f24-422e-accc-53b8200c10a7)|
